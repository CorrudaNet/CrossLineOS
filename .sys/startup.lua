...
if fs.exists("disk/") then
    ...
    multishell.setTitle(multishell.getCurrent(), "Setup")
    
    textutils.slowPrint("Do you have a monitor connected to the computer? Y/N")
    
    answer = read()
    
    if answer == "Y" then
    settings.define("connected.monitor", {
        description = "Whether monitor is connected or not",
        default = 1,
        type = "number"
        })
    end
